...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The CancelFluid recording.
    /// </summary>
    [TestModule("8628dfaa-fde5-425d-aee4-71054a054ec5", ModuleType.Recording, 1)]
    public partial class CancelFluid : ITestModule
    {
        /// <summary>
        ...
        static CancelFluid instance = new CancelFluid();
        ...
        /// </summary>
        public static CancelFluid Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'AddFluidInput.ButtonCancel' at Center.", repo.AddFluidInput.ButtonCancelInfo, new RecordItemIndex(0));
            repo.AddFluidInput.ButtonCancel.Click();
            Delay.Milliseconds(200);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating NotExists on item 'FrmORMain.FluidBalance.AddedFluidInputDetail'.", repo.FrmORMain.FluidBalance.AddedFluidInputDetailInfo, new RecordItemIndex(1));
            Validate.NotExists(repo.FrmORMain.FluidBalance.AddedFluidInputDetailInfo);
