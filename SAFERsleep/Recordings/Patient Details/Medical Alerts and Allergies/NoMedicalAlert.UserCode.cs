...
{
    public partial class NoMedicalAlert
    {
        /// <summary>
        ...
        public void Mouse_Click_MedicalAlertNo(RepoItemInfo rawtextInfo)
        {     
            if (rawtextInfo.Exists(5000))
    		{
    			...
    			Ranorex.Report.Info("Patient Medical Alerts already set");
        }
