...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Pain_Pres_PCEA_Apply_Template recording.
    /// </summary>
    [TestModule("33a3e4b2-4d8a-445d-8e34-adcf524f079d", ModuleType.Recording, 1)]
    public partial class Pain_Pres_PCEA_Apply_Template : ITestModule
    {
        /// <summary>
        ...
        static Pain_Pres_PCEA_Apply_Template instance = new Pain_Pres_PCEA_Apply_Template();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Pain_Pres_PCEA_Apply_Template()
        {
            BlockName = "";
        }
        ...
        /// </summary>
        public static Pain_Pres_PCEA_Apply_Template Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("8f4a9d63-a456-4a6f-a7e1-ddcebc9673d1")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'TemplateAdministration.PCEA.EpiduralAnalgesiaTab' at Center.", repo.TemplateAdministration.PCEA.EpiduralAnalgesiaTabInfo, new RecordItemIndex(3));
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'TemplateConfirmation.EpiduralAnalgesia' at Center.", repo.TemplateConfirmation.EpiduralAnalgesiaInfo, new RecordItemIndex(7));
            repo.TemplateConfirmation.EpiduralAnalgesia.Click();
            Delay.Milliseconds(200);
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left DoubleClick item 'AddPainPrescription.RegionalBlock' at Center.", repo.AddPainPrescription.RegionalBlockInfo, new RecordItemIndex(9));
            repo.AddPainPrescription.RegionalBlock.DoubleClick();
            Delay.Milliseconds(200);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$BlockName'.", new RecordItemIndex(10));
            Keyboard.Press(BlockName);
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'AddPainPrescription.Acknowledge' at Center.", repo.AddPainPrescription.AcknowledgeInfo, new RecordItemIndex(11));
            repo.AddPainPrescription.Acknowledge.Click();
            Delay.Milliseconds(200);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'AddPainPrescription.ButtonOK' at Center.", repo.AddPainPrescription.ButtonOKInfo, new RecordItemIndex(12));
